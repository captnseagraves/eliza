...
async function handler(runtime: IAgentRuntime, message: Memory): Promise<boolean> {
    try {
        ...
        console.log("📝 [rsvpEvaluator] Composing extraction context");
        ...
        console.log("🤖 [rsvpEvaluator] Generating extraction result");
